...
(async function () {
	...
	model = await tf.loadModel('https://github.com/LanderLupz/Landz/model_final/model.json');
...
$("#predict-button").click(async function () {
	...
	// There's no need to load this file because it was imported in Analyzer.php
	...
	let top5 = Array.from(predictions)
		...
		top5.forEach(function (p) {
			...
			$("#prediction-list").append(`<li style="list-style-type:none;"><b>PREDICTION: </b> ${p.className} Probability: ${p.probability.toFixed(3)}</li>`);
